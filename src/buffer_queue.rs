use crate::core_foundation_sys::base::{
    Boolean, CFAllocatorRef, CFComparisonResult, CFTypeID, CFTypeRef, OSStatus,
};
...
pub type CMBufferGetBooleanCallback =
    extern "C" fn(buf: CMBufferRef, refcon: *mut c_void) -> Boolean;
pub type CMBufferCompareCallback =
    extern "C" fn(buf1: CMBufferRef, buf2: CMBufferRef, refcon: *mut c_void) -> CFComparisonResult;
...
pub type CMBufferQueueTriggerCallback =
    extern "C" fn(triggerRefcon: *mut c_void, triggerToken: CMBufferQueueTriggerToken);
...
pub type CMBufferValidationCallback = extern "C" fn(
    queue: CMBufferQueueRef,
    buf: CMBufferRef,
    validationRefCon: *mut c_void,
) -> OSStatus;
